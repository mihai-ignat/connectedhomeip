...
#define EMBER_AF_AUDIOU_OUTPUT_FEATURE_NAME_UPDATES (1)
#define EMBER_AF_AUDIOU_OUTPUT_FEATURE_NAME_UPDATES_OFFSET (0)
...
#define EMBER_AF_DL_ALARM_MASK_LOCKING_MECHANISM_JAMMED (1)
#define EMBER_AF_DL_ALARM_MASK_LOCKING_MECHANISM_JAMMED_OFFSET (0)
#define EMBER_AF_DL_ALARM_MASK_LOCK_RESET_TO_FACTORY_DEFAULTS (2)
#define EMBER_AF_DL_ALARM_MASK_LOCK_RESET_TO_FACTORY_DEFAULTS_OFFSET (1)
#define EMBER_AF_DL_ALARM_MASK_RESERVED (4)
#define EMBER_AF_DL_ALARM_MASK_RESERVED_OFFSET (2)
#define EMBER_AF_DL_ALARM_MASK_RF_MODULE_POWER_CYCLED (8)
#define EMBER_AF_DL_ALARM_MASK_RF_MODULE_POWER_CYCLED_OFFSET (3)
#define EMBER_AF_DL_ALARM_MASK_WRONG_CODE_ENTRY_LIMIT (16)
#define EMBER_AF_DL_ALARM_MASK_WRONG_CODE_ENTRY_LIMIT_OFFSET (4)
#define EMBER_AF_DL_ALARM_MASK_FRONT_ESCUTCHEON_REMOVED_FROM_MAIN (32)
...
#define EMBER_AF_WC_FEATURE_LIFT (1)
#define EMBER_AF_WC_FEATURE_LIFT_OFFSET (0)
#define EMBER_AF_WC_FEATURE_TILT (2)
#define EMBER_AF_WC_FEATURE_TILT_OFFSET (1)
#define EMBER_AF_WC_FEATURE_POSITION_AWARE_LIFT (4)
#define EMBER_AF_WC_FEATURE_POSITION_AWARE_LIFT_OFFSET (2)
#define EMBER_AF_WC_FEATURE_ABSOLUTE_POSITION (8)
#define EMBER_AF_WC_FEATURE_ABSOLUTE_POSITION_OFFSET (3)
#define EMBER_AF_WC_FEATURE_POSITION_AWARE_TILT (16)
#define EMBER_AF_WC_FEATURE_POSITION_AWARE_TILT_OFFSET (4)
