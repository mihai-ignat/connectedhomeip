...
#define ZCL_SET_PIN_CODE_COMMAND_ID (0x05)
#define ZCL_GET_PIN_CODE_COMMAND_ID (0x06)
#define ZCL_GET_PIN_CODE_RESPONSE_COMMAND_ID (0x06)
#define ZCL_CLEAR_PIN_CODE_COMMAND_ID (0x07)
#define ZCL_CLEAR_ALL_PIN_CODES_COMMAND_ID (0x08)
...
#define ZCL_SET_RFID_CODE_COMMAND_ID (0x16)
#define ZCL_GET_RFID_CODE_COMMAND_ID (0x17)
#define ZCL_GET_RFID_CODE_RESPONSE_COMMAND_ID (0x17)
#define ZCL_CLEAR_RFID_CODE_COMMAND_ID (0x18)
#define ZCL_CLEAR_ALL_RFID_CODES_COMMAND_ID (0x19)
...
#define ZCL_OPERATING_EVENT_NOTIFICATION_COMMAND_ID (0x20)
...
#define ZCL_GET_RELAY_STATUS_LOG_RESPONSE_COMMAND_ID (0x01)
...
#define ZCL_CHANGE_CHANNEL_REQUEST_COMMAND_ID (0x00)
#define ZCL_CHANGE_CHANNEL_RESPONSE_COMMAND_ID (0x01)
#define ZCL_CHANGE_CHANNEL_BY_NUMBER_REQUEST_COMMAND_ID (0x02)
#define ZCL_SKIP_CHANNEL_REQUEST_COMMAND_ID (0x03)

// Commands for cluster: Target Navigator
#define ZCL_NAVIGATE_TARGET_REQUEST_COMMAND_ID (0x00)
...
#define ZCL_SEEK_REQUEST_COMMAND_ID (0x0B)

// Commands for cluster: Media Input
#define ZCL_SELECT_INPUT_REQUEST_COMMAND_ID (0x00)
#define ZCL_SHOW_INPUT_STATUS_REQUEST_COMMAND_ID (0x01)
#define ZCL_HIDE_INPUT_STATUS_REQUEST_COMMAND_ID (0x02)
#define ZCL_RENAME_INPUT_REQUEST_COMMAND_ID (0x03)

// Commands for cluster: Low Power
#define ZCL_SLEEP_COMMAND_ID (0x00)

// Commands for cluster: Keypad Input
#define ZCL_SEND_KEY_REQUEST_COMMAND_ID (0x00)
#define ZCL_SEND_KEY_RESPONSE_COMMAND_ID (0x01)

// Commands for cluster: Content Launcher
#define ZCL_LAUNCH_CONTENT_REQUEST_COMMAND_ID (0x00)
#define ZCL_LAUNCH_URL_REQUEST_COMMAND_ID (0x01)
#define ZCL_LAUNCH_RESPONSE_COMMAND_ID (0x02)

// Commands for cluster: Audio Output
#define ZCL_SELECT_OUTPUT_REQUEST_COMMAND_ID (0x00)
#define ZCL_RENAME_OUTPUT_REQUEST_COMMAND_ID (0x01)

// Commands for cluster: Application Launcher
#define ZCL_LAUNCH_APP_REQUEST_COMMAND_ID (0x00)
#define ZCL_STOP_APP_REQUEST_COMMAND_ID (0x01)
#define ZCL_HIDE_APP_REQUEST_COMMAND_ID (0x02)
#define ZCL_LAUNCHER_RESPONSE_COMMAND_ID (0x03)


// Commands for cluster: Account Login
#define ZCL_GET_SETUP_PIN_REQUEST_COMMAND_ID (0x00)
#define ZCL_GET_SETUP_PIN_RESPONSE_COMMAND_ID (0x01)
#define ZCL_LOGIN_REQUEST_COMMAND_ID (0x02)
#define ZCL_LOGOUT_REQUEST_COMMAND_ID (0x03)
