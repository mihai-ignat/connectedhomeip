...
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 355 - TxBroadcastCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 359 - TxAckRequestedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 363 - TxAckedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 367 - TxNoAckRequestedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 371 - TxDataCount, */\
  0x00, 0x00, 0x00, 0x00, \
...
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 395 - TxDirectMaxRetryExpiryCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 399 - TxIndirectMaxRetryExpiryCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 403 - TxErrCcaCount, */\
  0x00, 0x00, 0x00, 0x00, \
...
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 439 - RxBeaconRequestCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 443 - RxOtherCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 447 - RxAddressFilteredCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 451 - RxDestAddrFilteredCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 455 - RxDuplicatedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 459 - RxErrNoFrameCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 463 - RxErrUnknownNeighborCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 467 - RxErrInvalidSrcAddrCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 471 - RxErrSecCount, */\
  0x00, 0x00, 0x00, 0x00, \
...
#define GENERATED_DEFAULTS_COUNT (57)
...
\
  ...
  { 0x00000002, ZAP_TYPE(OCTET_STRING), 17, 0, ZAP_LONG_DEFAULTS_INDEX(325) }, /* NetworkName */  \
  { 0x00000003, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0000) }, /* PanId */  \
  { 0x00000004, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(327) }, /* ExtendedPanId */  \
  ...
  { 0x00000009, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(343) }, /* PartitionId */  \
  ...
  { 0x00000016, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(347) }, /* TxTotalCount */  \
  { 0x00000017, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(351) }, /* TxUnicastCount */  \
  { 0x00000018, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(355) }, /* TxBroadcastCount */  \
  { 0x00000019, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(359) }, /* TxAckRequestedCount */  \
  { 0x0000001A, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(363) }, /* TxAckedCount */  \
  { 0x0000001B, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(367) }, /* TxNoAckRequestedCount */  \
  { 0x0000001C, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(371) }, /* TxDataCount */  \
  { 0x0000001D, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(375) }, /* TxDataPollCount */  \
  { 0x0000001E, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(379) }, /* TxBeaconCount */  \
  { 0x0000001F, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(383) }, /* TxBeaconRequestCount */  \
  { 0x00000020, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(387) }, /* TxOtherCount */  \
  { 0x00000021, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(391) }, /* TxRetryCount */  \
  { 0x00000022, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(395) }, /* TxDirectMaxRetryExpiryCount */  \
  { 0x00000023, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(399) }, /* TxIndirectMaxRetryExpiryCount */  \
  { 0x00000024, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(403) }, /* TxErrCcaCount */  \
  { 0x00000025, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(407) }, /* TxErrAbortCount */  \
  { 0x00000026, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(411) }, /* TxErrBusyChannelCount */  \
  { 0x00000027, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(415) }, /* RxTotalCount */  \
  { 0x00000028, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(419) }, /* RxUnicastCount */  \
  { 0x00000029, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(423) }, /* RxBroadcastCount */  \
  { 0x0000002A, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(427) }, /* RxDataCount */  \
  { 0x0000002B, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(431) }, /* RxDataPollCount */  \
  { 0x0000002C, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(435) }, /* RxBeaconCount */  \
  { 0x0000002D, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(439) }, /* RxBeaconRequestCount */  \
  { 0x0000002E, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(443) }, /* RxOtherCount */  \
  { 0x0000002F, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(447) }, /* RxAddressFilteredCount */  \
  { 0x00000030, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(451) }, /* RxDestAddrFilteredCount */  \
  { 0x00000031, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(455) }, /* RxDuplicatedCount */  \
  { 0x00000032, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(459) }, /* RxErrNoFrameCount */  \
  { 0x00000033, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(463) }, /* RxErrUnknownNeighborCount */  \
  { 0x00000034, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(467) }, /* RxErrInvalidSrcAddrCount */  \
  { 0x00000035, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(471) }, /* RxErrSecCount */  \
  { 0x00000036, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(475) }, /* RxErrFcsCount */  \
  { 0x00000037, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(479) }, /* RxErrOtherCount */  \
  { 0x00000038, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(483) }, /* ActiveTimestamp */  \
  { 0x00000039, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(491) }, /* PendingTimestamp */  \
  { 0x0000003A, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(499) }, /* delay */  \
  { 0x0000003B, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), ZAP_EMPTY_DEFAULT() }, /* SecurityPolicy */  \
  { 0x0000003C, ZAP_TYPE(OCTET_STRING), 5, 0, ZAP_LONG_DEFAULTS_INDEX(503) }, /* ChannelMask */  \
  ...
  { 0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0, ZAP_LONG_DEFAULTS_INDEX(510) }, /* FeatureMap */  \
  { 0x0000FFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */  \
\
...
\
  ...
  { 0x00000000, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(514) }, /* groupKeyMap */  \
  { 0x00000001, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(768) }, /* groupTable */  \
  { 0x0000FFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */  \
\
...
\
  ...
  { 0x00000015, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(2) }, /* min heat setpoint limit */  \
  { 0x00000016, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(3) }, /* max heat setpoint limit */  \
  { 0x00000017, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(4) }, /* min cool setpoint limit */  \
  { 0x00000018, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(5) }, /* max cool setpoint limit */  \
  { 0x00000019, ZAP_TYPE(INT8S), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(6) }, /* min setpoint dead band */  \
  { 0x0000001B, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(7) }, /* control sequence of operation */  \
  { 0x0000001C, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(8) }, /* system mode */  \
  ...
  { 0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1022) }, /* FeatureMap */  \
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0000001F, ZAP_ATTRIBUTE_INDEX(6), 0, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Access Control (server) */ \
  ...
  { 0x00000029, ZAP_ATTRIBUTE_INDEX(26), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 0, Cluster: OTA Software Update Provider (client) */ \
  { 0x0000002A, ZAP_ATTRIBUTE_INDEX(27), 0, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: OTA Software Update Requestor (server) */ \
  ...
  { 0x00000035, ZAP_ATTRIBUTE_INDEX(59), 65, 247, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Thread Network Diagnostics (server) */ \
  { 0x00000038, ZAP_ATTRIBUTE_INDEX(124), 0, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Time Synchronization (server) */ \
  { 0x0000003C, ZAP_ATTRIBUTE_INDEX(124), 4, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: AdministratorCommissioning (server) */ \
  { 0x0000003E, ZAP_ATTRIBUTE_INDEX(128), 7, 4, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0000003F, ZAP_ATTRIBUTE_INDEX(135), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Group Key Management (server) */ \
  { 0x00000003, ZAP_ATTRIBUTE_INDEX(138), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Identify (client) */ \
  { 0x00000003, ZAP_ATTRIBUTE_INDEX(139), 3, 5, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayIdentifyServer }, /* Endpoint: 1, Cluster: Identify (server) */ \
  { 0x0000002F, ZAP_ATTRIBUTE_INDEX(142), 0, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Power Source (server) */ \
  { 0x00000201, ZAP_ATTRIBUTE_INDEX(142), 19, 34, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayThermostatServer }, /* Endpoint: 1, Cluster: Thermostat (server) */ \
  { 0x00000204, ZAP_ATTRIBUTE_INDEX(161), 0, 0, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(PRE_ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayThermostatUserInterfaceConfigurationServer }, /* Endpoint: 1, Cluster: Thermostat User Interface Configuration (server) */ \
  { 0x00000402, ZAP_ATTRIBUTE_INDEX(161), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */ \
  { 0x00000405, ZAP_ATTRIBUTE_INDEX(165), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Relative Humidity Measurement (server) */ \
  { 0x00000406, ZAP_ATTRIBUTE_INDEX(169), 0, 0, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOccupancySensingServer }, /* Endpoint: 1, Cluster: Occupancy Sensing (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 16, 1843 }, \
  { ZAP_CLUSTER_INDEX(16), 8, 57 }, \
}
...
#define ATTRIBUTE_MAX_SIZE (1900)
...
// Array of device ids
#define FIXED_DEVICE_IDS { 22, 769 }
