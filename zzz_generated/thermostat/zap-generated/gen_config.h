...
#define EMBER_AF_TIME_SYNCHRONIZATION_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define EMBER_AF_PLUGIN_TIME_SYNCHRONIZATION_SERVER
#define EMBER_AF_PLUGIN_TIME_SYNCHRONIZATION
