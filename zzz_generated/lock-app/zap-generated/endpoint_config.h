...
\
  ...
  { 0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0, ZAP_LONG_DEFAULTS_INDEX(633) }, /* FeatureMap */  \
...
\
  ...
  { 0x00000002, ZAP_TYPE(CHAR_STRING), 61, 0, ZAP_LONG_DEFAULTS_INDEX(637) }, /* Description */  \
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x00000006, ZAP_ATTRIBUTE_INDEX(169), 7, 13, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 1, Cluster: On/Off (server) */ \
  { 0x0000001D, ZAP_ATTRIBUTE_INDEX(176), 5, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Descriptor (server) */ \
  { 0x0000002F, ZAP_ATTRIBUTE_INDEX(181), 9, 133, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Power Source (server) */ \
}
...
#define ATTRIBUTE_MAX_SIZE (1258)
