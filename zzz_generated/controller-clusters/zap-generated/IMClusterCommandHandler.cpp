...
{
wasHandled = emberAfAccountLoginClusterGetSetupPINResponseCallback(aCommandPath.mEndpointId, apCommandObj, setupPIN);
        }
            break;
        }
        default: {
...
{
wasHandled = emberAfApplicationLauncherClusterLauncherResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, data);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfChannelClusterChangeChannelResponseCallback(aCommandPath.mEndpointId, apCommandObj, channelMatch, errorType);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfContentLauncherClusterLaunchResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, data);
        }
            break;
        }
        default: {
...
{
wasHandled = emberAfDiagnosticLogsClusterRetrieveLogsResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, content, timeStamp, timeSinceBoot);
        }
            break;
        }
        default: {
...
{
wasHandled = emberAfDoorLockClusterGetCredentialStatusResponseCallback(aCommandPath.mEndpointId, apCommandObj, credentialExists, userIndex, nextCredentialIndex);
        }
            break;
        }
...
{
wasHandled = emberAfDoorLockClusterGetUserResponseCallback(aCommandPath.mEndpointId, apCommandObj, userIndex, userName, userUniqueId, userStatus, userType, credentialRule, credentials, creatorFabricIndex, lastModifiedFabricIndex, nextUserIndex);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfDoorLockClusterSetCredentialResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, userIndex, nextCredentialIndex);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfGeneralCommissioningClusterArmFailSafeResponseCallback(aCommandPath.mEndpointId, apCommandObj, errorCode, debugText);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfGeneralCommissioningClusterCommissioningCompleteResponseCallback(aCommandPath.mEndpointId, apCommandObj, errorCode, debugText);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfGeneralCommissioningClusterSetRegulatoryConfigResponseCallback(aCommandPath.mEndpointId, apCommandObj, errorCode, debugText);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfGroupKeyManagementClusterKeySetReadAllIndicesResponseCallback(aCommandPath.mEndpointId, apCommandObj, groupKeySetIDs);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfGroupKeyManagementClusterKeySetReadResponseCallback(aCommandPath.mEndpointId, apCommandObj, groupKeySet);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfGroupsClusterGetGroupMembershipResponseCallback(aCommandPath.mEndpointId, apCommandObj, capacity, groupList);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfGroupsClusterRemoveGroupResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, groupId);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfGroupsClusterViewGroupResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, groupId, groupName);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterConnectNetworkResponseCallback(aCommandPath.mEndpointId, apCommandObj, NetworkingStatus, DebugText, ErrorValue);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterNetworkConfigResponseCallback(aCommandPath.mEndpointId, apCommandObj, NetworkingStatus, DebugText);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterScanNetworksResponseCallback(aCommandPath.mEndpointId, apCommandObj, NetworkingStatus, DebugText, WiFiScanResults, ThreadScanResults);
        }
            break;
        }
        default: {
...
{
wasHandled = emberAfOtaSoftwareUpdateProviderClusterQueryImageResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, delayedActionTime, imageURI, softwareVersion, softwareVersionString, updateToken, userConsentNeeded, metadataForRequestor);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterAttestationResponseCallback(aCommandPath.mEndpointId, apCommandObj, AttestationElements, Signature);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterCertificateChainResponseCallback(aCommandPath.mEndpointId, apCommandObj, Certificate);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterNOCResponseCallback(aCommandPath.mEndpointId, apCommandObj, StatusCode, FabricIndex, DebugText);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterOpCSRResponseCallback(aCommandPath.mEndpointId, apCommandObj, NOCSRElements, AttestationSignature);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfScenesClusterAddSceneResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, groupId, sceneId);
        }
            break;
        }
...
{
wasHandled = emberAfScenesClusterGetSceneMembershipResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, capacity, groupId, sceneCount, sceneList);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfScenesClusterRemoveAllScenesResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, groupId);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfScenesClusterRemoveSceneResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, groupId, sceneId);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfScenesClusterStoreSceneResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, groupId, sceneId);
        }
            break;
        }
...
{
wasHandled = emberAfScenesClusterViewSceneResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, groupId, sceneId, transitionTime, sceneName, extensionFieldSets);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfTargetNavigatorClusterNavigateTargetResponseCallback(aCommandPath.mEndpointId, apCommandObj, status, data);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfTestClusterClusterTestAddArgumentsResponseCallback(aCommandPath.mEndpointId, apCommandObj, returnValue);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfTestClusterClusterTestEmitTestEventResponseCallback(aCommandPath.mEndpointId, apCommandObj, value);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfTestClusterClusterTestListInt8UReverseResponseCallback(aCommandPath.mEndpointId, apCommandObj, arg1);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfTestClusterClusterTestNullableOptionalResponseCallback(aCommandPath.mEndpointId, apCommandObj, wasPresent, wasNull, value, originalValue);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfTestClusterClusterTestSpecificResponseCallback(aCommandPath.mEndpointId, apCommandObj, returnValue);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 6 == validArgumentCount)
{
wasHandled = emberAfThermostatClusterGetRelayStatusLogResponseCallback(aCommandPath.mEndpointId, apCommandObj, timeOfDay, relayStatus, localTemperature, humidityInPercentage, setpoint, unreadEntries);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfThermostatClusterGetWeeklyScheduleResponseCallback(aCommandPath.mEndpointId, apCommandObj, numberOfTransitionsForSequence, dayOfWeekForSequence, modeForSequence, payload);
        }
            break;
        }
        default: {
