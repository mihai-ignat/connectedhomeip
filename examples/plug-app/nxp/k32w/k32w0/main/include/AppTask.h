...
public:
    ...
    void PostTurnOnActionRequest(int32_t aActor, PlugManager::Action_t aAction);
    void PostOTAResume();
...
private:
    ...
    static void ActionInitiated(PlugManager::Action_t aAction, int32_t aActor);
    static void ActionCompleted(PlugManager::Action_t aAction);
